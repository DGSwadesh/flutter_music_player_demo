                ...
                if (!running) ...[
                  ...
                  StreamBuilder<QueueState>(
                    ...
                    builder: (context, snapshot) {
                      ...
                      final queue =
                          queueState == null ? [] : queueState.queue ?? [];
                      final mediaItem =
                          queueState == null ? null : queueState.mediaItem;
                      return Column(
                        ...
                        children: [
                          ...
                          if (mediaItem != null) Text(mediaItem.title),
                        ],
                      );
                    },
                  ),
                  ...
                  StreamBuilder<MediaState>(
                    ...
                    builder: (context, snapshot) {
                      ...
                      return SeekBar(
                        duration: mediaState == null
                            ? Duration.zero
                            : mediaState.mediaItem?.duration ?? Duration.zero,
                        position: mediaState == null
                            ? Duration.zero
